...
```bash
git remote add encore encore://vaquinha-social-frontend-uo9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/vaquinha-social-frontend-uo9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/vaquinha-social-frontend-uo9i/settings/integrations/github)
